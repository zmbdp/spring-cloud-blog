...
//        return QueueBuilder.durable(RabbitMqConstants.REGISTER_QUEUE_NAME) // 声明邮件队列名称
//                .build();
//    }
//
//    /**
...
//        return QueueBuilder.durable(RabbitMqConstants.CAPTCHA_QUEUE_NAME).build(); // 声明验证码队列名称
//    }
//
//    /**
//     * 声明邮件相关操作的交换机
...
//        return ExchangeBuilder.fanoutExchange(RabbitMqConstants.USER_EXCHANGE_NAME) // 声明一个交换机
//                .durable(true) // 是否持久化
//                .build();
//    }
//
...
//        return QueueBuilder.durable(RabbitMqConstants.UPDATE_USER_QUEUE_NAME).build(); // 声明修改用户数据的队列名称
//    }
//
//    /**
//     * 绑定邮件队列和交换机
...
//    public Binding updateUserBinding(@Qualifier("updateUserQueue") Queue updateUserQueue, @Qualifier("userExchange") FanoutExchange userExchange) {
//        return BindingBuilder.bind(updateUserQueue).to(userExchange);
//    }
...
//        return QueueBuilder.durable(RabbitMqConstants.USER_DELAY_QUEUE_NAME)
//                .withArgument("x-dead-letter-exchange", RabbitMqConstants.USER_DELAY_DLX_EXCHANGE_NAME)
//                .withArgument("x-dead-letter-routing-key", RabbitMqConstants.USER_DELAY_DLX_ROUTING_KEY)
//                .build();
//    }
//
//    /**
...
//                RabbitMqConstants.USER_DELAY_EXCHANGE_NAME,
//                "x-delayed-message",
//                true,
//                false,
//                args
...
//                .with(RabbitMqConstants.USER_DELAY_ROUTING_KEY)
//                .noargs();
//    }
//
//    /**
...
//        return QueueBuilder.durable(RabbitMqConstants.USER_DELAY_DLX_QUEUE_NAME).build();
//    }
//
//    /**
//     * 声明死信交换机（DLX）
...
//        return new DirectExchange(RabbitMqConstants.USER_DELAY_DLX_EXCHANGE_NAME, true, false);
//    }
//
//    /**
//     * 将死信队列绑定到死信交换机
...
//                .with(RabbitMqConstants.USER_DELAY_DLX_ROUTING_KEY);
//    }
...
//     * 监听主延迟队列
//     */
//    @RabbitListener(queues = RabbitMqConstants.USER_DELAY_QUEUE_NAME)
...
//     * 监听死信队列（使用新名称）
//     */
//    @RabbitListener(queues = RabbitMqConstants.USER_DELAY_DLX_QUEUE_NAME)
...
//                RabbitMqConstants.USER_DELAY_EXCHANGE_NAME, // 交换机名称
//                RabbitMqConstants.USER_DELAY_ROUTING_KEY,    // 路由键
//                data,
//                message -> {
//                    // 设置延迟时间（毫秒）
